    ...
    <el-aside class="taskAside" id="leftAside">
      <div style="text-align: center;line-height: 0px;">
        ...
        <el-menu default-active="2" class="el-menu-vertical-demo">
          <el-menu-item v-for="item in this.$store.state.taskProcessing.allTask" :index="item.uid"
...
<script>
  ...
  export default {
    ...
    methods: {
            ...
            if (response.data.body != '获取文件失败') {
              ...
              for (var i = 0; i < bomMes.length; i++) {
                ...
                bom = {
                  ...
                  fileSize: bomMes[i].fileSize / 1024 + 'KB',
      ...
      // input框回车  搜索
      onSubmit () {
        var kk = this.$store.state.taskProcessing.allTask
        if (this.search) {
          ...
          this.axios.post('apis/tc/task', this.qs.stringify({type: '3'})
            ...
            this.$store.commit('taskProcessing/saveAllTask', {
