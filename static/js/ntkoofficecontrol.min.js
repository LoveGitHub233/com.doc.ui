...
/*                   version:1.7.3                      */
/*                   number:002                         */
/* 2019.09.04版本跟随 北京机电工程研究所20190911 产品发送*/
/*------------------------------------------------------*/
//64位控件的calssid
...
var MakerKey="";
//密钥
var ProductCaption="北京机电工程研究所";
//密钥
var ProductKey="1408E6CF659F05114580081E6B53FF6AD088CCE6";
//解除时间密钥
var NoExpireKey="";
...
谷歌浏览器事件接管
*/
function ntkosavetourl(type,code,a)
{
	//alert("SaveToURL成功回调");
  var startSuccess = a.indexOf("success");
  var endSuccess = a.indexOf("message");
  var success = a.substring(startSuccess+9,endSuccess-2);

  var startMessage = a.indexOf("message");
  var endMessage = a.indexOf("body");
  var message = a.substring(startMessage+9,endMessage-2);

  if(success == "false"){
    TANGER_OCX_OBJ.ShowTipMessage("提示",message);
    window.opener=null;
    window.open('','_self');''
    window.close();
  }else
...
function ntkoondocumentopened(type,code){
  ...
  if(fileType == 1){
    document.getElementById("officecontrol").style.height="100%";
    TANGER_OCX_OBJ.SetReadOnly(true,"123456");
  }else if(fileType == 2){
    document.getElementById("postilButton").style.display="inline-block";
    ...
    document.getElementById("noSaveButton").style.display="inline-block";
    document.getElementById("saButton").style.display="inline-block";
    TANGER_OCX_OBJ.EnterRevisionMode(true,"123456");
  }
}
if (browser=="IE"){
